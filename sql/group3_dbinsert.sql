...
BEGIN
    ...
    ELSIF s = 4 THEN
        RAISE_APPLICATION_ERROR(-20004, 'UNCONFIRMED');
    END IF;
...
INSERT INTO ORDERS
VALUES ('2201123456', '22222222', '1-MAY-2020', 0, 0, 'Credit Card', '123456789');
INSERT INTO ORDERS
VALUES ('1101123456', '11111111', '26-APR-2020', 0, 30, 'Credit Card', '987654321');
